...
export default function MovieCard({movieClick, SetDisplay}) {
  ...
  useEffect(()=>{
    ...
    .then(response =>  setMovieInfo(response.data))
      ...
      return (
        <div>
        <div className="card flex w-fit md:w-auto h-100  p-10 mb-20 mx-10  border bg-purple-400 text-black-600  rounded-lg shadow hover:shadow-lg">
        <div className="flex justify-end absolute right-2 top-2">
          ...
          <img className="rounded-t-lg mx-auto w-fit h-80 object-cover" src= {MovieInfo?.Poster} alt={MovieInfo?.Title}/>
